<?php
	...
	*/
	...
	/**
		...
		* Usage:
		* <code>
		*	$bk = new Backup(array('user', 'media'));
		*
		*	//to save the dump to a specific file
		*	$bk->save('path/to/my/file.sql');
		*
		*	//access the sql dump
		*	echo $bk->_content;
		* </code>
	...
	*/
	...
	class Backup{
		...
		/**
			...
			*
			* @access	public
			* @param	string|array [$tables] Tables to backup, '*' for all tables, 'mytable' for a specific table or an array of wished tables
		*/
