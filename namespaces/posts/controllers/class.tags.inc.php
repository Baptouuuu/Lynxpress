<?php
	...
	*/
	...
	use \Site\Posts\Html\Tags as Html;
	...
	/**
		* Controllers that display the list of published posts
		*
		* @package		Site
	...
	*/
	...
	final class Tags extends Controller{
		...
		*/
		...
		public function __construct(){
			...
			$this->_tag = trim(htmlspecialchars(VGet::id(false)));
			...
			Template::publish('posts.tags.'.$this->_tag);
		...
		*/
		...
		private function get_posts(){
			...
			try{
				...
				$to_read['condition_columns'][':t'] = '_tags';
				$to_read['condition_select_types'][':t'] = 'LIKE';
				$to_read['condition_values'][':t'] = '%'.$this->_tag.'%';
		...
		*/
		...
		private function build_title(){
			...
			$this->_title = 'Posts > Tag "'.$this->_tag.'"';
