<?php
	...
	*/
	...
	use \Site\Albums\Html\Category as Html;
	
	defined('FOOTPRINT') or die();
	
	/**
		* Display a list of published albums for a specific category
		*
		* @package		Site
	...
	final class Category extends Controller{
		...
		*/
		...
		public function __construct(){
			...
			Template::publish('albums.category.'.$this->_category);
		...
		private function build_title(){
			...
			foreach($this->_categories as $c)
				if($c->_id == $this->_category){
					...
					$this->_title = 'Albums > Category "'.$c->_name.'"';
					break;
